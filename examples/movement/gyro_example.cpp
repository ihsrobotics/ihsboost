...
int main() {
    ...
    // go forward for 6 seconds, accelerating from 0 to 100 and checking for
    // straightness using the gyroscope
    gyro_drive_straight(0, 100, Timer(6));
    // turn degrees using the gyroscope
    // turn 90 degrees by slowing down the right wheel
    // speeds are {left, right}, so we keep left wheel at speed 100 but
    // gradually slow right wheel down to 11
