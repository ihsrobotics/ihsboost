...
bool is_black(int val) { return val <= get_config().getInt("black"); }

bool is_white(int val) { return val > get_config().getInt("black"); }

void line_follow_accelerate(Cliff cliff_sensor,
                            LineSide line_side,
                            std::function<bool()> stop_condition,
                            AccelerateController &accelerator,
                            bool stop,
    ...
    create_drive_direct(static_cast<int>(accelerator.speed()),
                        static_cast<int>(accelerator.speed()));
    while (!stop_condition()) {
        cur_val = sensor();
        if (line_side == LeftSide) {
            if (cur_val > black_val) { // on white
                create_drive_direct(static_cast<int>(accelerator.speed() /
...
void line_follow_basic(int speed,
                       Cliff cliff_sensor,
                       LineSide line_side,
                       std::function<bool()> stop_condition,
                       bool stop,
    ...
    line_follow_accelerate(cliff_sensor,
                           line_side,
                           stop_condition,
                           accelerator,
                           stop,
...
void line_follow_accelerate_linear(int from_speed,
                                   int to_speed,
                                   Cliff cliff_sensor,
                                   LineSide line_side,
                                   std::function<bool()> stop_condition,
...
void line_follow_accelerate_sinusoidal(int from_speed,
                                       int to_speed,
                                       Cliff cliff_sensor,
                                       LineSide line_side,
                                       std::function<bool()> stop_condition,
                                       ...
                                       int black_val,
                                       int updates_per_sec) {
    SinusoidalController accelerator(
        from_speed, to_speed, accel_per_sec, updates_per_sec);
    line_follow_accelerate(cliff_sensor,
                           line_side,
                           stop_condition,
...
void align(std::function<bool(int)> condition,
           int speed,
...
void align_with_black(int speed,
                      int correction_speed,
                      Cliff cliff_sensor_l,
                      Cliff cliff_sensor_r,
                      bool stop,
...
void align_with_white(int speed,
                      int correction_speed,
                      Cliff cliff_sensor_l,
                      Cliff cliff_sensor_r,
                      bool stop,
