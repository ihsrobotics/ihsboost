...
void export_movement()
{
    ...
    def("gyro_drive_straight", gyro_drive_straight_fn, (arg("speed"), arg("stop_function"), arg("stop") = get_config().getBool("gyro_stop"), arg("correction_proportion") = get_config().getDouble("gyro_correction_proportion"), arg("updates_per_sec") = get_config().getInt("gyro_updates_per_sec")));
    def("gyro_turn_degrees", gyro_turn_degrees_v1, (arg("turn_speed"), arg("degrees"), arg("updates_per_sec") = get_config().getInt("gyro_updates_per_sec")));
    def("gyro_turn_degrees_v2", gyro_turn_degrees_v2, (arg("max_speed"), arg("degrees"), arg("min_speed") = get_config().getInt("gyro_min_speed"), arg("accel_per_sec") = get_config().getDouble("gyro_accel_per_sec"), arg("updates_per_sec") = get_config().getInt("gyro_updates_per_sec")));
